...
namespace w3tools.Workflows
{
    ...
    {
        public WCC_occlusion()
        {
            Name = "Generate Occlusiondata";
        }
    ...
    {
        public WCC_GenerateNavData()
        {
            Name = "Generate Navdata";
        }
    ...
    {
        public WCC_PackDLCAndCreateMetadatastore()
        {
            Name = "Pack DLC and Create Metadata";
        }
    ...
    {
        public WCC_PackMODAndCreateMetadatastore()
        {
            Name = "Pack Mod and Create Metadata";
        }
    ...
    {
        public WCC_GenerateTextureCache()
        {
            Name = "Generate Texture Cache";
        }
    ...
    {
        public WCC_GenerateCollisionCache()
        {
            Name = "Generate Collision Cache";
        }
